...
(2) some other filter conditions see clean_en().
(3) build tsv en-lang pairs with corresponding corpus for further manual check

The output will be en-lang.tsv files in the merged_dir, by default, merged_parallel
'''
import fasttext
...
if __name__ =='__main__':
    ...
    print('Total num of sentences: ')
    print(len(en_list))
    print('Total num of words in English:')
